...
class Token
{
     ...
     */
    public static function build($uuid, $channel=null)
    {
    ...
    {
        return env('token.prefix', 'token') . "_{$channel}_{$token}";
    }
     ...
     */
    public static function invalid($channel = null)
    {
        $channel = $channel ?? app('http')->getName();
        $token = self::getToken();
        if($token){
     ...
     */
    public static function refresh($refreshToken, $channel = null)
    {
        $channel = $channel ?? app('http')->getName();
